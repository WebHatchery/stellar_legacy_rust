...
mod food_balance {
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/tests/unit/simulation/autoplay/tests/food_balance.rs"));
}

mod ship_work {
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/tests/unit/simulation/autoplay/tests/ship_work.rs"));
}
